                        ...
                        <div class='d-flex align-items-end row'>
                            ...
                            <div class='col-sm-5 text-center text-sm-left'>
                                <div class='card-body pb-0 px-0 px-md-4'>
                                    <img
                                        src='/temp/assets/img/illustrations/man-with-laptop-light.png'
                                        height='140'
                                        alt='View Badge User'
                                ...
                                <div class='card-body'>
                                    ...
                                    >
                                        <div class='avatar flex-shrink-0'>
                                            <img
                                                src='/temp/assets/img/icons/unicons/chart-success.png'
                                                alt='chart success'
                                                class='rounded'
                                            />
                                        </div>
                                    ...
                                    >Khách hàng </span>
                                    <h3 class='card-title mb-2'>67</h3>
                            ...
                            <div class='card'>
                                <div class='card-body'>
                                    ...
                                    >
                                        <div class='avatar flex-shrink-0'>
                                            <img
                                                src='/temp/assets/img/icons/unicons/wallet-info.png'
                                                alt='Credit Card'
                                                class='rounded'
                                            />
                                        </div>
